...
export const ArticleDetail: React.FC<ArticleDetailProps> = ({ article, onBack, isSaved, onToggleSave, onDelete, currentUser }) => {
  ...
  return (
    <div className="min-h-screen bg-[#f5f5f7] animate-[fadeIn_0.3s_ease-out] relative">
      {/* Toast Notification */}
      <div 
        className={`fixed top-24 right-4 sm:right-10 bg-black/80 backdrop-blur-md text-white px-8 py-4 rounded-full shadow-2xl transition-all duration-300 z-[60] flex items-center gap-3 ${
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div className="flex flex-wrap gap-4 justify-between items-center mb-10">
          ...
          <div className="flex gap-2 sm:gap-3 relative">
            ...
            <button 
              ...
              className={`p-3 rounded-full transition-all shadow-sm border border-gray-100/50 ${
                isSaved 
        ...
        <article className="bg-white rounded-[3rem] p-6 md:p-16 shadow-sm border border-gray-100">
          ...
          <div className="max-w-3xl mx-auto">
            ...
            {/* Dummy Content for Layout Check */}
            {getDummyContent()}
